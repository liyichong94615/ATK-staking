...
import nftOnwerImage from "../../assets/images/nftOnwerImage.png";
        ...
        <SettingArea>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <SocialInfo>Land Plots</SocialInfo>
            </div>
          </div>
          <PriceInputArea>
            <div
            ...
            >
              <DiscordImage src={nftOnwerImage} alt="nftImage" />
              <div
                style={{
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                <PriceDetailTxt>My Wallet</PriceDetailTxt>
                <SocialText
                  style={{
                    color: "black",
                    marginLeft: 0,
            ...
            >
              <PriceDetailTxt>Network Fee</PriceDetailTxt>
              <PriceDetailTxt
                style={{
                  fontFamily: "Oswald-Regular",
                  opacity: "1",
